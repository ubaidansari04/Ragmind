          ...
          >
            ...
            <div
              style={{
                ...
                border: `1.5px solid ${errors.email ? "#e05c5c" : "rgba(0, 200, 180, 0.2)"}`,
                borderRadius: "10px",
          ...
          >
            ...
            <div
              style={{
                ...
                gap: "0.75rem",
                background: "rgba(0, 0, 0, 0.35)",
                border: `1.5px solid ${errors.password ? "#e05c5c" : "rgba(0, 200, 180, 0.2)"}`,
                borderRadius: "10px",
                padding: "0.9rem 1.1rem",
                transition: "border-color 0.2s",
              }}
            ...
            {/* Forgot password */}
            {/* <div style={{ textAlign: "right", marginTop: "0.1rem" }}>
              <a
                href="#"
                style={{
                  color: "#00c8b0",
